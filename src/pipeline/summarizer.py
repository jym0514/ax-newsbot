...
오늘 큐레이션된 기사 목록을 읽고, 가장 중요한 흐름과 시사점을 4~5개의 한국어 문장으로 압축합니다.

규칙:
- 정확히 4~5 문장. 각 문장은 한 줄로 작성.
- 문장과 문장 사이는 줄바꿈(\\n)으로만 구분합니다. 빈 줄·번호·불릿·하이픈 같은 기호는 절대 쓰지 않습니다.
- 개별 기사를 나열하지 말고, 여러 기사를 관통하는 패턴·테마·시사점을 짚습니다.
- 첫 줄은 오늘의 가장 큰 흐름을 한 문장으로 요약.
- 이어지는 줄들은 주요 동향 2~3개를 묶어 설명.
- 마지막 줄은 기업·실무 관점의 시사점.
